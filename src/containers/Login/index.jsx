        ...
        <Container ref={containerRef}>
            ...
            <RightContainer>
                ...
                <Form onSubmit={handleSubmit(onSubmit)} noValidate>
                    <InputContainer>
                        <label>Usuário</label>
                        <input type="email" placeholder="seu@email.com" autoComplete="username" {...register("email")} />
                    ...
                    <div style={{ textAlign: 'right', marginBottom: '20px', marginTop: '-10px' }}>
                        <Link to={`/${barbershopSlug}/esqueci-senha`} style={{ fontSize: '11px' }}>
                            Esqueceu sua senha?
                        </Link>
                    </div>
                ...
                <FooterText>
                    <p>Não possui conta? <Link to={`/${barbershopSlug}/cadastro`}> Clique aqui.</Link></p>
                </FooterText>
            </RightContainer>
        </Container>
    );
