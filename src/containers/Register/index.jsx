...
export function Register() {
    ...
    const schema = yup.object({
        ...
        acceptsPrivacyPolicy: yup
            .boolean()
            .oneOf([true], "Você precisa aceitar a Política de Privacidade para continuar.")
            .required(),
    }).required();
    ...
    const onSubmit = async data => {
        try {
            ...
            if (status === 200 || status === 201) {
                ...
                toast.error("Email já está cadastrado, faça login para continuar 😉​😉​");
            } else {
                throw new Error();
            }
            ...
            <RightContainer>
                ...
                <Form onSubmit={handleSubmit(onSubmit)} noValidate>
                    ...
                    <InputContainer>
                        ...
                        <input type="tel" placeholder="(00) 00000-0000" {...register("client_phone")} />
                    ...
                    <InputContainer>
                        <label style={{ display: "flex", alignItems: "flex-start", gap: 8, textAlign: "left" }}>
                            <input type="checkbox" {...register("acceptsPrivacyPolicy")} style={{ marginTop: 3 }} />
                            <span>
                                Li e aceito a{" "}
                ...
                <FooterText>
                    <p>Já possui conta? <Link to={`/${barbershopSlug}/login`}> Clique aqui.</Link></p>
                </FooterText>
            </RightContainer>
        </Container>
    );
