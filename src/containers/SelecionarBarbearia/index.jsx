    ...
    return (
        <div style={{ background: C.bg, minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", padding: 20 }}>
            <form onSubmit={handleSubmit} style={{ maxWidth: 360, width: "100%", textAlign: "center" }}>
                <h2 style={{ fontFamily: font.display, color: C.gold, marginBottom: 12 }}>
                    Bem-vindo(a)
                </h2>
                <p style={{ fontFamily: font.body, color: C.muted, fontSize: 14, marginBottom: 24 }}>
                    Digite o nome da barbearia sem espaços para continuar, por exemplo: barbeariadojoao, barbearia123, etc.
                </p>
                <input
                    type="text"
