        ...
        <Container>
            <Wrapper>
                ...
                <Card>
                    ...
                    <CardDescription>
                        Mantenha seu nome e telefone atualizados para facilitações no agendamento.
                    </CardDescription>
                    ...
                    {!showProfileForm ? (
                        ...
                        <Form onSubmit={handleSubmitProfile(handleUpdateProfile)} noValidate>
                            <InputContainer>
                ...
                <Card>
                    ...
                    {!showPasswordForm ? (
                        ...
                        <Form onSubmit={handleSubmitPassword(handleUpdatePassword)} noValidate>
                            <InputContainer>
                            ...
                            <InputContainer>
                                ...
                                <InputError>{passwordErrors?.confirm_new_password?.message}</InputError>
                            </InputContainer>
            ...
            {confirmOpen && (
                <ConfirmOverlay>
                    <ConfirmBox>
                        ...
                        <ConfirmActions>
                            <ActionButton onClick={() => setConfirmOpen(false)} disabled={deleting}>
                                Cancelar
                            </ActionButton>
                            <ActionButton $danger onClick={handleExcluirConta} disabled={deleting}>
